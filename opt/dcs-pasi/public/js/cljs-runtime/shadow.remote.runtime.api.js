...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_40962 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_40962(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_40963 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_40963(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_40964 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_40964(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_40965 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_40965(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_40966 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_40966(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_40967 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_40967(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__40953,callback){
var map__40954 = p__40953;
var map__40954__$1 = cljs.core.__destructure_map(map__40954);
var input = map__40954__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40954__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40954__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
