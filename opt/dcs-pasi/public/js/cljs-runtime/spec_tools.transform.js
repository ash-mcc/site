...
if((x instanceof cljs.core.Keyword)){
var G__26484 = spec;
var G__26485 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__26484,G__26485) : f.call(null,G__26484,G__26485));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__26486 = spec;
var G__26487 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__26486,G__26487) : f.call(null,G__26486,G__26487));
} else {
return x;
...
if(typeof x === 'number'){
var G__26488 = spec;
var G__26489 = spec_tools.transform.number__GT_string(spec,x);
...
}catch (e26490){if((e26490 instanceof Error)){
var ___$1 = e26490;
return x;
} else {
throw e26490;
...
}catch (e26491){if((e26491 instanceof Error)){
var ___$1 = e26491;
return x;
} else {
throw e26491;
...
}catch (e26495){if((e26495 instanceof Error)){
var ___$1 = e26495;
return x;
} else {
throw e26495;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__26496,x){
var map__26497 = p__26496;
var map__26497__$1 = cljs.core.__destructure_map(map__26497);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26497__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__26498,x){
var map__26499 = p__26498;
var map__26499__$1 = cljs.core.__destructure_map(map__26499);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26499__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__26500,x){
var map__26501 = p__26500;
var map__26501__$1 = cljs.core.__destructure_map(map__26501);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26501__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
