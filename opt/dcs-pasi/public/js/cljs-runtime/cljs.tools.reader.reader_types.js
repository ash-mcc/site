...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_23668 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_23668(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_23673 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_23673(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23677 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_23677(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23678 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_23678(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23679 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_23679(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23681 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_23681(reader);
}
});
...
var G__23746 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__23747 = s.append(c);
c = G__23746;
s = G__23747;
continue;
}
