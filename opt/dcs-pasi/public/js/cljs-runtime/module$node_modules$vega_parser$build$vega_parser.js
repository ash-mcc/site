...
1,extra=!0,offset$jscomp$0=0):(band$jscomp$0=.5,extra=!1):(band$jscomp$0=_$jscomp$0("bandPosition"),extra=_$jscomp$0("tickExtra"));var JSCompiler_object_inline_extra_2975=extra;var JSCompiler_object_inline_band_2976=band$jscomp$0;var JSCompiler_object_inline_offset_2977=offset$jscomp$0;const datum={scale:_$jscomp$1.scale,ticks:!!_$jscomp$0("ticks"),labels:!!_$jscomp$0("labels"),grid:!!_$jscomp$0("grid"),domain:!!_$jscomp$0("domain"),title:null!=_$jscomp$1.title},dataRef=ref$jscomp$0(scope.add(Collect({},
[datum]))),ticksRef=ref$jscomp$0(scope.add(AxisTicks({scale:scope.scaleRef(_$jscomp$1.scale),extra:scope.property(JSCompiler_object_inline_extra_2975),count:scope.objectProperty(_$jscomp$1.tickCount),values:scope.objectProperty(_$jscomp$1.values),minstep:scope.property(_$jscomp$1.tickMinStep),formatType:scope.property(_$jscomp$1.formatType),formatSpecifier:scope.property(_$jscomp$1.format)}))),children=[];let size;if(datum.grid){var JSCompiler_temp_const$jscomp$1=children.push,userEncode=encode$jscomp$0.grid;
