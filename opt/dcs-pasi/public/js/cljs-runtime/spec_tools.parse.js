...
var fexpr__26424 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__26424.cljs$core$IFn$_invoke$arity$1 ? fexpr__26424.cljs$core$IFn$_invoke$arity$1(type) : fexpr__26424.call(null,type));
});
...
var G__26442 = spec_tools.impl.normalize_symbol(x);
var G__26443 = null;
var G__26444 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__26442,G__26443,G__26444) : spec_tools.parse.parse_form.call(null,G__26442,G__26443,G__26444));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__26445 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__26446 = x;
var G__26447 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__26445,G__26446,G__26447) : spec_tools.parse.parse_form.call(null,G__26445,G__26446,G__26447));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__26482 = cljs.spec.alpha.form(x);
var G__26483 = options;
x = G__26482;
options = G__26483;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__26448 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__26449 = null;
var G__26450 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__26448,G__26449,G__26450) : spec_tools.parse.parse_form.call(null,G__26448,G__26449,G__26450));
} else {
...
var or__4253__auto__ = new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460).cljs$core$IFn$_invoke$arity$1(parse_data);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
var G__26451 = parse_data;
var G__26451__$1 = (((G__26451 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__26451));
var G__26451__$2 = (((G__26451__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__26451__$1));
var G__26451__$3 = (((G__26451__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__26451__$2));
var G__26451__$4 = (((G__26451__$3 == null))?null:cljs.core.seq(G__26451__$3));
if((G__26451__$4 == null)){
return null;
} else {
return cljs.core.set(G__26451__$4);
}
}
});
if((typeof spec_tools !== 'undefined') && (typeof spec_tools.parse !== 'undefined') && (typeof spec_tools.parse.parse_form !== 'undefined')){
} else {
spec_tools.parse.parse_form = (function (){var method_table__4747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__4748__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__26452 = cljs.core.get_global_hierarchy;
...
return dispatch;
}),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850),hierarchy__4751__auto__,method_table__4747__auto__,prefer_table__4748__auto__,method_cache__4749__auto__,cached_hierarchy__4750__auto__));
})();
}
...
var map__26453 = spec_tools.impl.parse_keys(form);
var map__26453__$1 = cljs.core.__destructure_map(map__26453);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26453__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26453__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26453__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26453__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26453__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__26454 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__26454__$1 = (cljs.core.truth_((function (){var or__4253__auto__ = req;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26454,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__26454);
if(cljs.core.truth_((function (){var or__4253__auto__ = opt;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return opt_un;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26454__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__26454__$1;
}
}));
...
var vec__26455 = multi_spec_form;
var seq__26456 = cljs.core.seq(vec__26455);
var first__26457 = cljs.core.first(seq__26456);
var seq__26456__$1 = cljs.core.next(seq__26456);
var _ = first__26457;
var first__26457__$1 = cljs.core.first(seq__26456__$1);
var seq__26456__$2 = cljs.core.next(seq__26456__$1);
var multi_method_symbol = first__26457__$1;
var ___$1 = seq__26456__$2;
var form = vec__26455;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__26458){
var vec__26459 = p__26458;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26459,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26459,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__26462_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__26462_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__26463_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__26463_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__26464_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__26464_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26465_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__26465_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__26466 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__26466__$1 = cljs.core.__destructure_map(map__26466);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26466__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__26467 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__26467__$1 = cljs.core.__destructure_map(map__26467);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26467__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__26468,options){
var vec__26469 = p__26468;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26469,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26469,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26469,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__26473,options){
...
var ___$1 = first__26476;
var values = seq__26475__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__26472_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__26472_SHARP_,options);
}),values);
...
var type_priority = (function (p1__26477_SHARP_){
var G__26480 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__26479 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__26477_SHARP_);
return (fexpr__26479.cljs$core$IFn$_invoke$arity$1 ? fexpr__26479.cljs$core$IFn$_invoke$arity$1(G__26480) : fexpr__26479.call(null,G__26480));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26478_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__26478_SHARP_,options);
}),cljs.core.rest(form))));
}));
