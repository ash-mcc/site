...
var periods__$1 = cljs.core.vec((function (){var G__44196 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__44195_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__44195_SHARP_,(0),(3));
}),G__44196);
} else {
return G__44196;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__44203){
var vec__44204 = p__44203;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44204,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44204,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__44207 = pattern;
switch (G__44207) {
case "S":
...
switch (G__44216__$1) {
case "millis":
return (function (p1__44208_SHARP_){
return p1__44208_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__44209_SHARP_){
return p1__44209_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__44210_SHARP_){
return p1__44210_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__44211_SHARP_){
return p1__44211_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__44212_SHARP_){
return p1__44212_SHARP_.getHours();
});

break;
case "day":
return (function (p1__44213_SHARP_){
return p1__44213_SHARP_.getDate();
});

break;
case "month":
return (function (p1__44214_SHARP_){
return p1__44214_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__44215_SHARP_){
return p1__44215_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__44216__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__44217){
var vec__44218 = p__44217;
var seq__44219 = cljs.core.seq(vec__44218);
var first__44220 = cljs.core.first(seq__44219);
var seq__44219__$1 = cljs.core.next(seq__44219);
var key = first__44220;
...
break;
case "ordinal-suffix":
var vec__44222 = (function (){var G__44225 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__44225) : syntax_list.call(null,G__44225));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44222,(0),null);
...
var d = value;
var G__44229 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__44230 = G__44229;
var seq__44231 = cljs.core.seq(vec__44230);
var first__44232 = cljs.core.first(seq__44231);
var seq__44231__$1 = cljs.core.next(seq__44231);
var unparser = first__44232;
var more = seq__44231__$1;
var s = "";
var d__$1 = d;
var G__44229__$1 = G__44229;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__44239 = G__44229__$1;
...
var unparser__$1 = first__44241;
var more__$1 = seq__44240__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__44242 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44242,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44242,(1),null);
var G__44271 = d__$3;
var G__44272 = more__$1;
var G__44273 = s__$3;
d__$1 = G__44271;
G__44229__$1 = G__44272;
s__$1 = G__44273;
continue;
}
break;
