...
var G__21271 = o;
reagent.impl.template.goog$module$goog$object.set(G__21271,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__21385__i < G__21385__a.length) {G__21385__a[G__21385__i] = arguments[G__21385__i + 0]; ++G__21385__i;}
  args = new cljs.core.IndexedSeq(G__21385__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21386);
...
var G__21273 = o;
reagent.impl.template.goog$module$goog$object.set(G__21273,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21387__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__21388__i < G__21388__a.length) {G__21388__a[G__21388__i] = arguments[G__21388__i + 0]; ++G__21388__i;}
  args = new cljs.core.IndexedSeq(G__21388__a,0,null);
} 
return G__21387__delegate.call(this,args);};
G__21387.cljs$lang$maxFixedArity = 0;
G__21387.cljs$lang$applyTo = (function (arglist__21389){
var args = cljs.core.seq(arglist__21389);
return G__21387__delegate(args);
});
...
var G__21276 = props;
var G__21276__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21276,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21276);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21276__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21280 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21280,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21280;
}
})(),id_class);
...
var G__21282 = (cljs.core.count(argv) - first_child);
switch (G__21282) {
case (0):
...
var vec__21289 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21289,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21289,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21289,(2),null);
...
var temp__5757__auto___21392 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___21392 == null)){
} else {
var key_21393 = temp__5757__auto___21392;
(jsprops.key = key_21393);
}
...
var temp__5757__auto___21394 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___21394 == null)){
} else {
var key_21395 = temp__5757__auto___21394;
(jsprops.key = key_21395);
}
...
var temp__5757__auto___21397 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___21397 == null)){
} else {
var key_21398 = temp__5757__auto___21397;
(jsprops.key = key_21398);
}
...
var temp__5757__auto___21402 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___21402 == null)){
} else {
var key_21403 = temp__5757__auto___21402;
(jsprops.key = key_21403);
}
...
var temp__5757__auto___21404 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___21404 == null)){
} else {
var key_21405 = temp__5757__auto___21404;
(jsprops.key = key_21405);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21330_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21330_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21337 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21337,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21337,(1),null);
...
break;
default:
var G__21421 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21422 = compiler;
v = G__21421;
compiler = G__21422;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21367 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21367 = (function (opts,id,fn_to_element,meta21368){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21367.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21369,meta21368__$1){
var self__ = this;
var _21369__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21367(self__.opts,self__.id,self__.fn_to_element,meta21368__$1));
}));

(reagent.impl.template.t_reagent$impl$template21367.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21369){
var self__ = this;
var _21369__$1 = this;
return self__.meta21368;
}));

(reagent.impl.template.t_reagent$impl$template21367.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21367.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21367.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21367.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21367.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta21368","meta21368",-1563891127,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21367.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21367.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21367");

(reagent.impl.template.t_reagent$impl$template21367.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template21367");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21367.
 */
reagent.impl.template.__GT_t_reagent$impl$template21367 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21367(opts__$1,id__$1,fn_to_element__$1,meta21368){
return (new reagent.impl.template.t_reagent$impl$template21367(opts__$1,id__$1,fn_to_element__$1,meta21368));
});

}

return (new reagent.impl.template.t_reagent$impl$template21367(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
