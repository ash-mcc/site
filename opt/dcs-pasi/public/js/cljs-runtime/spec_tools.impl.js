...
var vec__26365 = cljs.core.rest(expr);
var seq__26366 = cljs.core.seq(vec__26365);
var first__26367 = cljs.core.first(seq__26366);
var seq__26366__$1 = cljs.core.next(seq__26366);
var vec__26368 = first__26367;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26368,(0),null);
var form = seq__26366__$1;
...
var G__26371 = x;
var G__26371__$1 = (((G__26371 == null))?null:spec_tools.impl.polish(G__26371));
var G__26371__$2 = (((G__26371__$1 == null))?null:cljs.core.name(G__26371__$1));
if((G__26371__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__26371__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__26372 = x;
var G__26372__$1 = (((G__26372 == null))?null:cljs.core.name(G__26372));
if((G__26372__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__26372__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__26373){
var map__26374 = p__26373;
var map__26374__$1 = cljs.core.__destructure_map(map__26374);
var data = map__26374__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26374__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26374__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26374__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26374__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__26375){
var map__26376 = p__26375;
var map__26376__$1 = cljs.core.__destructure_map(map__26376);
var data = map__26376__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26376__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26376__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__26377 = data;
var G__26377__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__26377,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__26377);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__26377__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__26377__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__26381 = form;
var G__26381__$1 = (((G__26381 == null))?null:cljs.core.rest(G__26381));
if((G__26381__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__26381__$1);
}
})();
var G__26382 = m;
var G__26382__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__26382,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__26378_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__26378_SHARP_)));
})):G__26382);
var G__26382__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__26382__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__26379_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__26379_SHARP_)));
})):G__26382__$1);
var G__26382__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__26382__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__26380_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__26380_SHARP_));
})):G__26382__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__26382__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__26387 = (function (){var G__26388 = form;
var G__26388__$1 = (((G__26388 == null))?null:cljs.core.rest(G__26388));
if((G__26388__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__26388__$1);
}
})();
var map__26387__$1 = cljs.core.__destructure_map(map__26387);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26387__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26387__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26387__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26387__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__26390 = (function (){var and__4251__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__26401 = form;
var G__26401__$1 = (((G__26401 == null))?null:cljs.core.seq(G__26401));
var G__26401__$2 = (((G__26401__$1 == null))?null:cljs.core.first(G__26401__$1));
if((G__26401__$2 == null)){
return null;
} else {
var fexpr__26402 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__26402.cljs$core$IFn$_invoke$arity$1 ? fexpr__26402.cljs$core$IFn$_invoke$arity$1(G__26401__$2) : fexpr__26402.call(null,G__26401__$2));
}
})():null));
});
/**
...
var G__26432 = (i__4865__auto___26429 + (1));
i__4865__auto___26429 = G__26432;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq26404){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq26404));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__26406){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__26413){
var map__26414 = p__26413;
var map__26414__$1 = cljs.core.__destructure_map(map__26414);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26414__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26414__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26414__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26414__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__26411_SHARP_){
return cljs.core.map_QMARK_(p1__26411_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__26412_SHARP_){
return cljs.core.contains_QMARK_(p1__26412_SHARP_,x);
});
}),req_keys));
