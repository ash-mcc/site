...
spec_tools.swagger.core.accept_spec = (function (){var method_table__4747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__4748__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__29526 = cljs.core.get_global_hierarchy;
return (fexpr__29526.cljs$core$IFn$_invoke$arity$0 ? fexpr__29526.cljs$core$IFn$_invoke$arity$0() : fexpr__29526.call(null));
})());
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("spec-tools.swagger.core","accept-spec"),spec_tools.swagger.core.spec_dispatch,new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456),hierarchy__4751__auto__,method_table__4747__auto__,prefer_table__4748__auto__,method_cache__4749__auto__,cached_hierarchy__4750__auto__));
})();
}
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__29540){
var map__29541 = p__29540;
var map__29541__$1 = cljs.core.__destructure_map(map__29541);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29541__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29541__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__29544 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29544,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29544,(1),null);
var swagger_meta = spec_tools.impl.unlift_keys(data,"swagger");
var or__4253__auto__ = new cljs.core.Keyword(null,"swagger","swagger",-79684232).cljs$core$IFn$_invoke$arity$1(data);
...
spec_tools.swagger.core.extract_parameter = (function (){var method_table__4747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__4748__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__29559 = cljs.core.get_global_hierarchy;
return (fexpr__29559.cljs$core$IFn$_invoke$arity$0 ? fexpr__29559.cljs$core$IFn$_invoke$arity$0() : fexpr__29559.call(null));
})());
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"in","in",-1531184865),"body",new cljs.core.Keyword(null,"name","name",1843675177),(function (){var or__4253__auto__ = spec_tools.impl.qualified_name(spec_tools.core.spec_name(spec));
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return "body";
}
})(),new cljs.core.Keyword(null,"description","description",-1428560544),(function (){var or__4253__auto__ = spec_tools.core.spec_description(spec);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return "";
...
var map__29572 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__29572__$1 = cljs.core.__destructure_map(map__29572);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29572__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29572__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__29575){
var vec__29576 = p__29575;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29576,(0),null);
var map__29579 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29576,(1),null);
var map__29579__$1 = cljs.core.__destructure_map(map__29579);
var schema = map__29579__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29579__$1,new cljs.core.Keyword(null,"type","type",1174270348));
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"in","in",-1531184865),cljs.core.name(in$),new cljs.core.Keyword(null,"name","name",1843675177),k,new cljs.core.Keyword(null,"description","description",-1428560544),(function (){var or__4253__auto__ = spec_tools.core.spec_description(spec);
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return "";
...
spec_tools.swagger.core.expand = (function (){var method_table__4747__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__4748__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__29597 = cljs.core.get_global_hierarchy;
return (fexpr__29597.cljs$core$IFn$_invoke$arity$0 ? fexpr__29597.cljs$core$IFn$_invoke$arity$0() : fexpr__29597.call(null));
})());
...
})(),(function (){var iter__4652__auto__ = (function spec_tools$swagger$core$iter__29604(s__29605){
return (new cljs.core.LazySeq(null,(function (){
var s__29605__$1 = s__29605;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__29605__$1);
if(temp__5753__auto__){
var s__29605__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29605__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__29605__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__29607 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__29606 = (0);
while(true){
if((i__29606 < size__4651__auto__)){
var vec__29608 = cljs.core._nth(c__4650__auto__,i__29606);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29608,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29608,(1),null);
cljs.core.chunk_append(b__29607,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29607),spec_tools$swagger$core$iter__29604(cljs.core.chunk_rest(s__29605__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29607),null);
}
} else {
var vec__29611 = cljs.core.first(s__29605__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29611,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29611,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__29604(cljs.core.rest(s__29605__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__29618){
var vec__29619 = p__29618;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29619,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29619,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__29624,p){
var vec__29626 = p__29624;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29626,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29626,(1),null);
var acc__$1 = vec__29626;
